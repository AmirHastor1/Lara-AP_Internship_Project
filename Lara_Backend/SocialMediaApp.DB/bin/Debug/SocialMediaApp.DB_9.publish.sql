...
GO
:setvar DatabaseName "SMA_DB"
:setvar DefaultFilePrefix "SMA_DB"
...
GO
PRINT N'Creating Table [dbo].[UserBlogs]...';
...
CREATE TABLE [dbo].[UserBlogs] (
    ...
    [BlogComments]    INT              NULL,
    [BlogDate]        DATETIME2 (7)    NOT NULL,
    CONSTRAINT [Pk_UserBlogs_BlogId] PRIMARY KEY CLUSTERED ([BlogId] ASC)
);


GO
PRINT N'Creating Foreign Key [dbo].[Fk_User_Blog_UserId]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[Fk_Blog_Comment_BlogId]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[Fk_User_Comment_UserId]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[Fk_UserBlogs_Comments_BlogId]...';


GO
ALTER TABLE [dbo].[Comments]
    ADD CONSTRAINT [Fk_UserBlogs_Comments_BlogId] FOREIGN KEY ([BlogId]) REFERENCES [dbo].[UserBlogs] ([BlogId]);


GO
PRINT N'Creating Foreign Key [dbo].[Fk_User_Comments_UserId]...';


GO
ALTER TABLE [dbo].[Comments]
    ADD CONSTRAINT [Fk_User_Comments_UserId] FOREIGN KEY ([UserId]) REFERENCES [dbo].[User] ([UserId]);


GO
PRINT N'Creating Foreign Key [dbo].[Fk_User_Notification_UserId]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[Fk_User_UserBlogs_UserId]...';
