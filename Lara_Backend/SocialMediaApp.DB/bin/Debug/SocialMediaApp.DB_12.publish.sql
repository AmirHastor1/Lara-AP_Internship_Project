...
GO
PRINT N'Creating Table [dbo].[Like]...';
...
CREATE TABLE [dbo].[Like] (
    ...
    [UserId] UNIQUEIDENTIFIER NOT NULL,
    [BlogId] UNIQUEIDENTIFIER NOT NULL,
    CONSTRAINT [Pk_Like_LikeId] PRIMARY KEY CLUSTERED ([LikeId] ASC)
);
...
GO
PRINT N'Creating Foreign Key [dbo].[Fk_User_Like_UserId]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[Fk_Blog_Like_BlogId]...';
